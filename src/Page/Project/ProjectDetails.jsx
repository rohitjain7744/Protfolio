...
import ecom6 from "../../assets/Project/ecom6.png";

//project3
import gym1 from "../../assets/Project/gym1.png";
import gym2 from "../../assets/Project/gym2.png";
import gym3 from "../../assets/Project/gym3.png";
import gym4 from "../../assets/Project/gym4.png";
import gym5 from "../../assets/Project/gym5.png";
...
const clientData = {
  ...
  // ── NOVAHIRE (Reference Standard) ──
  'novahire': {
    id: 'novahire',
    name: 'NovaHire Recruitment System',
    heroTag: 'Full-Stack Enterprise Solution',
    num: '01',
    accent: '#6c47ff', 
    description: 'A production-grade recruitment platform built to bridge the gap between recruiters and job seekers with a secure, role-based ecosystem.',
    challenge: 'Architecting a system that manages role-based access control (RBAC) while ensuring sensitive user data is protected.',
  ...
  // ── E-COMMERCE (Fixed & Updated to match NovaHire format) ──
  'ecommerce': {
    id: 'ecommerce',
    name: 'MERN E-Commerce Platform',
    heroTag: 'Scalable Full-Stack Solution', // Match heroTag key
    num: '02',
    accent: '#ff6b47', // Orange accent for shopping vibes
    description: 'A scalable full-stack e-commerce platform covering product listing, real-time cart management, and end-to-end checkout flow.',
    challenge: 'Building a full-stack e-commerce application that supports real-time cart updates and secure checkout while maintaining performance under load.',
    solution: 'Implemented MERN stack (React, Node, Express, MongoDB). Used WebSockets for real-time inventory and integrated Stripe API for secure, production-ready payment processing.',
    tech: ['React.js', 'Node.js', 'css', 'MongoDB', 'WebSockets', 'Stripe API'],
    results: ['Real-time Cart Updates', 'Secure Checkout Flow', 'Scalable Architecture'],
    // Using 'photos' key instead of 'runtimePhotos' to match NovaHire
    photos: [ecom1, ecom2, ecom3, ecom4, ecom5, ecom6 
    ],
    feedback: 'This project demonstrates my ability to build complex full-stack applications with real-time features and secure payment processing.',
    client: 'Full-Stack Software Project',
    link: 'https://ecommerce-platform.com', // Match link key
    github: 'https://github.com/rohitjain7744'
  },
  'health-sync': {
    name: 'Health Sync',  
    heroTag: 'Real-Time Health Surveillance',
    num: '04',
    accent: '#00c9a7',
    description: 'A real-time health surveillance system that monitors member vitals and triggers automated emergency alerts via SMS and Email.', 
    ...
    tech: ['React.js', 'Spring Boot', 'MySQL', 'Twilio API'],
    results: ['Real-time health monitoring', 'Automated emergency alerts', 'Scalable microservices architecture'],
    photos: [ gym1, gym2, gym3, gym4, gym5, gym6
    ],  
    feedback: 'The technical depth and implementation quality provided by Rohit helped us scale our operations effectively.',
    client: 'CTO, Health Sync',
  },
  ...
  if (!project) {
    return (
      <div className="cd-not-found">
        ...
        <Link to="/project" className="cd-back">
