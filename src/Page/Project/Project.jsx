...
const clientProjects = [
 {
    ...
    description:
      'A production-grade recruitment platform featuring secure JWT authentication, role-based access control, and seamless cloud infrastructure management.',
    tags: ['React.js', 'Spring Boot', 'JWT', 'Railway'],
  ...
  },
{
...
},
  {
    ...
    description:
      'A modern e-commerce platform with real-time inventory management, secure payment processing, and seamless user experience.',
  ...
  category: 'Health Tech & Alert Systems',
  description:
    'A real-time health surveillance system that monitors member vitals and triggers automated emergency alerts via SMS and Email.',
        ...
        <div className="cp-header">
          <Reveal>
            <div className="cp-eyebrow">
              ...
              <FaBriefcase /> DEPLOYED APPLICATIONS
            </div>
          </Reveal>

          <Reveal delay={0.08}>
            <h1 className="cp-h1">
              Scalable  <em>Solutions</em><br />Real Results.
            </h1>
          </Reveal>

          <Reveal delay={0.16}>
            <p className="cp-header-sub">
             “Crafting high-performance web applications with modern full-stack technologies.”

Developer-focused premium heading.
            </p>
            <div className="cp-count">
              <span className="cp-count-dot" />
              {clientProjects.length} Project Showcase
            </div>
          </Reveal>
        </div>
              ...
              >
                ...
                <div className="cp-img-wrap">
                  ...
                  <div className="cp-img-overlay">
                    <Link to={`/projectDetails/${project.id}`} className="cp-view-btn">
